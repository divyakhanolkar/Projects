...
apollo_control=list(modelName  ="M4",
                    modelDescr ="M3 minus Angle",
                    indivID    ="InvID")
...
apollo_probabilities = function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[["left_acc"]]	    =	asc_left_acc     + b_dir*dest_dist_left_acc	      +	b_car_dist*car_dist_left_acc	     + b_prevChoice*PrevChoice_1 + b_car_vel*v_Vehicle_Effect
  V[["right_acc"]]	  =	asc_right_acc	   + b_dir*dest_dist_right_acc      +	b_car_dist*car_dist_right_acc	     + b_prevChoice*PrevChoice_2 + b_car_vel*v_Vehicle_Effect
  V[["centre_acc"]]	  =	asc_centre_acc	 + b_dir*dest_dist_central_acc	  +	b_car_dist*car_dist_central_acc    + b_prevChoice*PrevChoice_3 + b_car_vel*v_Vehicle_Effect
  V[["left_dec"]] 	  =	asc_left_dec	   + b_dir*dest_dist_left_dec	      +	b_car_dist*car_dist_left_dec	     + b_prevChoice*PrevChoice_7 + b_car_vel*v_Vehicle_Effect
  V[["right_dec"]]	  =	asc_right_dec	   + b_dir*dest_dist_right_dec      +	b_car_dist*car_dist_right_dec	     + b_prevChoice*PrevChoice_8 + b_car_vel*v_Vehicle_Effect
  V[["centre_dec"]]	  =	asc_centre_dec	 + b_dir*dest_dist_central_dec	  + b_car_dist*car_dist_central_dec    + b_prevChoice*PrevChoice_9 + b_car_vel*v_Vehicle_Effect
  V[["left_const"]]	  =	asc_left_const	 + b_dir*dest_dist_left_const     +	b_car_dist*car_dist_left_const	   + b_prevChoice*PrevChoice_4 + b_car_vel*v_Vehicle_Effect
  V[["right_const"]]	=	asc_right_const	 + b_dir*dest_dist_right_const	  +	b_car_dist*car_dist_right_const    + b_prevChoice*PrevChoice_5 + b_car_vel*v_Vehicle_Effect
  V[["centre_const"]]	=	                   b_dir*dest_dist_central_const	+	b_car_dist*car_dist_central_const  + b_prevChoice*PrevChoice_6 
...
M4 = apollo_estimate(apollo_beta,
                     apollo_fixed,
                     apollo_probabilities,
                     apollo_inputs)
apollo_modelOutput( M4)

#LR Test --------------------------------------------------------------------
LR = apollo_lrTest(M1,M4)
