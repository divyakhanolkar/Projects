...
apollo_control=list(modelName  ="M6",
                    modelDescr ="M5 minus direction",
                    indivID    ="InvID")
...
apollo_probabilities = function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[["left_acc"]]	    =	asc_left_acc     +	b_car_dist*car_dist_left_acc	    + b_car_vel*v_Vehicle_Effect
  V[["right_acc"]]	  =	asc_right_acc	   +	b_car_dist*car_dist_right_acc	    + b_car_vel*v_Vehicle_Effect
  V[["centre_acc"]]	  =	asc_centre_acc	 +	b_car_dist*car_dist_central_acc   + b_car_vel*v_Vehicle_Effect
  V[["left_dec"]] 	  =	asc_left_dec	   +	b_car_dist*car_dist_left_dec	    + b_car_vel*v_Vehicle_Effect
  V[["right_dec"]]	  =	asc_right_dec	   +	b_car_dist*car_dist_right_dec	    + b_car_vel*v_Vehicle_Effect
  V[["centre_dec"]]	  =	asc_centre_dec	 +  b_car_dist*car_dist_central_dec   + b_car_vel*v_Vehicle_Effect
  V[["left_const"]]	  =	asc_left_const	 +	b_car_dist*car_dist_left_const	  + b_car_vel*v_Vehicle_Effect
  V[["right_const"]]	=	asc_right_const	 +	b_car_dist*car_dist_right_const   + b_car_vel*v_Vehicle_Effect
  V[["centre_const"]]	=	                 +	b_car_dist*car_dist_central_const  
...
M6 = apollo_estimate(apollo_beta,
                     apollo_fixed,
                     apollo_probabilities,
                     apollo_inputs)
apollo_modelOutput(M6)

#LR Test --------------------------------------------------------------------
LR = apollo_lrTest(M1,M6)
