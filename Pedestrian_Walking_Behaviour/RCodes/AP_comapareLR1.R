...
apollo_control=list(modelName  ="M2",
                    modelDescr ="Constants only Model",
                    indivID    ="InvID")
...
apollo_probabilities = function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  mnl_settings = list(						       ### Define settings for model 
    ...
    avail        = list(left_acc = 1, right_acc = 1, centre_acc = 1, left_dec = 1, right_dec = 1, centre_dec = 1, left_const = 1, 
                        right_const = 1, centre_const = 1),
